...
- Column order can't matter. Neither can case or spacing, and at least one file
  has a BOM on it.
- Some customers still send the old name for a renamed field. The contract
  lists what the old names were. Both can turn up in the same file.
